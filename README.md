<p align="center">
    <!-- pypi-strip -->
    <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://xywu.me/research/pointcept/logo_v2.png">
    <source media="(prefers-color-scheme: light)" srcset="https://xywu.me/research/pointcept/logo_v2.png">
    <!-- /pypi-strip -->
    <img alt="pointcept" src="https://xywu.me/research/pointcept/logo_v2.png" width="400">
    <!-- pypi-strip -->
    </picture><br>
    <!-- /pypi-strip -->

[//]: # (    <strong>Point</strong> Cloud Per<strong>cept</strong>ion Codebase)
</p>
...
<p align="center">
  <img src="docs/offset.png" width="480">
</p>
